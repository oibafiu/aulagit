                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right animated zoomIn">
                                <ul class="dropdown-user">
                                    <li><a href="profile"><i class="ti-user"></i> Perfil</a></li>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-briefcase"></i><span class="hide-menu">Relatórios <span></span></span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="entradas">Relatório Mensal</a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow" href="#" aria-expanded="false"><i class="fa fa-file-pdf-o"></i><span class="hide-menu">Documentos</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="docs">Documentos Empresariais</a></li>
                                <li><a href="outros">Outros Documentos</a></li>
                                
                            </ul>
                        </li>
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-barcode"></i><span class="hide-menu">Recibos</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="recibo">Pagamentos</a></li>
